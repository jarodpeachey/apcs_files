...
public class Magpie13 {
  ...
  public String getResponse(String statement) {
    ...
    if (statement.length() == 0) {
      ...
      if (!foundYouMe) {
        int positionTwo = findKeyword(statement, "I", 0);

        if (positionTwo >= 0 && findKeyword(statement, "you", positionTwo) >= 0) {
   ...
   * be really happy if you had <something>?"
   * 
  ...
  /**
   * Take a statement with "I <something> you" and transform it into "Why do
   * you <something> me?"
   * 
  ...
  private String transformIYouStatement(String statement) {
    ...
    int positionOfYou = findKeyword(statement, "you", positionOfI + 2);
