...
public class ElectionTestSeven {
  ...
  public static void removeCandidate(int position) {
    if (position > candidates.length) {
      System.out.println("<< Error removing a candidate from position " + position + ": that candidate does not exist. >>");
    } else {
      System.out.println("<< Removing the candidate, " + candidates[position].getName() + ", from position " + position + " >>");
  ...
  public static void removeCandidate(String nameSearch) {
    ...
    if (foundMatch) {
      System.out.println("<< Removing " + candidates[index].getName() + ", in position " + index + ", from candidates. >>");
