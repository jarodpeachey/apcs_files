...
public class EmissionsTest5 {
  public static void main(String[] args) {
    ArrayList<Emissions5> households = new ArrayList<Emissions5>();
    households.add(new Emissions5(5, false, true, false, false));
    households.add(new Emissions5(2, false, true, false, false));
    households.add(new Emissions5(6, false, false, true, false));
    households.add(new Emissions5(1, true, false, false, true));
    households.add(new Emissions5(3, false, true, false, false));
    households.add(new Emissions5(4, true, false, true, false));

    for (Emissions5 dataRecord : households) {
