...
public class Magpie2 {
  ...
  public String getResponse(String statement) {
    ...
    } else if (statement.indexOf("dog") >= 0 || statement.indexOf("cat") >= 0 || statement.indexOf("pet") >= 0) {
      response = "Aw, I love pets. Tell me more!";
    } else if (statement.indexOf("Mears") >= 0) {
      response = "Cool. He sounds awesome!";
    } else if (statement.indexOf("guitar") >= 0 || statement.indexOf("violin") >= 0 || statement.indexOf("piano") >= 0
        || statement.indexOf("guitar") >= 0) {
      response = "Hey, I love music!";
    } else if (statement.indexOf("hobby") >= 0) {
      response = "Cool! Do you have any more hobbies?";
    } else if (statement.indexOf("dinner") >= 0 || statement.indexOf("lunch") >= 0
        || statement.indexOf("breakfast") >= 0 || statement.indexOf("food") >= 0) {
      response = "Yummy! I love food! What's your favorite?";
    } else if (statement.trim().length() < 2) {
  ...
  private String getRandomResponse() {
    ...
    if (whichResponse == 0) {
      ...
      response = "Makes sense. Tell me more.";
    }
