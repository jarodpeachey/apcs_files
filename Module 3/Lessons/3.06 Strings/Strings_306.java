/**
 * The purpose of this program is to demonstrate the use of several methods of
 * the String class.
 * 
 * @author Ada Lovelace
 * @version 06/03/17
 */
public class Strings_306 {
  public static void main(String[] args) {
    String str = "Truly wonderful, the mind of a child is.";
    System.out.println(str.indexOf("won"));
    ...
    String testStr = "Turly wonderful, the mind of a child is.";
    System.out.println(testStr.indexOf("full"));
  }// end of main method
}// end of class
