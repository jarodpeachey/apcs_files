...
public class Emissions {
   ...
   */
  Emissions(int numPeople, boolean paper, boolean plastic, boolean glass, boolean cans) {
  ...
  public void calcGrossWasteEmission() {
    double grossEmissions = 1018 * myNumPeople;

    myEmissions = grossEmissions;
  }
  ...
  public void calcWasteReduction() {
    ...
    if (myPaper) {
      totalReduction += (184.0 * myNumPeople);
    } else if (myPlastic) {
      totalReduction += (25.6 * myNumPeople);
    } else if (myGlass) {
      totalReduction += (46.6 * myNumPeople);
    } else if (myCans) {
      totalReduction += (165.8 * myNumPeople);
    }

    myReduction = totalReduction;
  }
